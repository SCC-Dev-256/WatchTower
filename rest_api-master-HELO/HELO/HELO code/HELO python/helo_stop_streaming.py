...
"""helo_stop_streaming - Send a 'stop streaming' command to the HELO's Replicator.  
   ...
   Example: $ python helo_stop_streaming.py http://192.168.0.2
   """
...
value = replicator_command_map["STOP_STREAMING"]
